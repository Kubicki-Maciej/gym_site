      ...
      >
        <Container maxWidth="lg">
          ...
          <Box sx={{ mb: { xs: 10, md: 14 }, maxWidth: 720 }}>
            ...
            >
              Współpraca z doświadczonym trenerem personalnym to najkrótsza
              droga do wymarzonych efektów. Niezależnie, czy dopiero zaczynasz,
              czy trenujesz od lat — profesjonalne oko zmienia wszystko.
              Poprawna technika, progresja obciążeń i dopasowana regeneracja
              sprawiają, że każda minuta na siłowni ma sens.
            </Typography>
          </Box>
